    ...
    return (
        <div className='flex flex-col gap-6'>
            ...
            {/* 
                        <ul className="flex items-center gap-3">
                            <li className="w-8 h-8 rounded-full ring-gray-300 cursor-pointer relative bg-red-500">
                                <div className='absolute w-10 h-10 rounded-full ring-2 top-1/2 left-1/2 trasform -translate-x-1/2 -translate-y-1/2' />
                            </li>
                            ...
                            <li className="w-8 h-8 rounded-full ring-gray-300 cursor-pointer relative bg-green-500">
                                <div className='absolute w-10 h-[2px] bg-red-400 rounded-full rotate-45 top-1/2 left-1/2 trasform -translate-x-1/2 -translate-y-1/2' />
                            </li>
                        </ul> */}
            {/* Others */}
            ...
            <ul className="flex items-center gap-3">
                ...
                <li className='ring-1 ring-red-400 bg-red-400 text-white rounded-md py-1 px-4 text-sm cursor-pointer'>
                    Medium
                </li>
                <li className='ring-1 ring-red-400 bg-pink-200 rounded-md py-1 px-4 text-sm cursor-pointer cursor-not-allowed'>
                    Large
                </li>
            </ul> */}
        </div>
